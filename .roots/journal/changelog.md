...
---
## Versión 18.0.26.127 — Las publicaciones sin video vuelven a subir a MercadoLibre [#492 / #577]
21 sep 2026
...
---
## Versión 18.0.26.124 — Las cancelaciones de MercadoLibre ahora se aplican de verdad [#494]
20 sep 2026
...
## Versión 18.0.26.96 — La cancelación automática vuelve a cancelar de verdad
23 ago 2026
...
*Esta protección ya existía en la versión 16 desde julio (caso Shoppy); esta versión la trae a Odoo 18.*

Requiere actualizar el módulo (`-u meli_oerp`).

## Versión 18.0.26.94 — El envío ya facturado deja de quedar en cero en la orden
21 ago 2026
...
## Versión 18.0.26.95 — El diagnóstico de stock ya no puede decir "todo bien" cuando no revisó nada [#535 Score]
19 ago 2026
...
## Versión 18.0.26.91 — Queda constancia cuando la importación de pedidos corta por el tope configurado
3 ago 2026
...
## Versión 18.0.26.90 — La devolución automática de ventas canceladas por ML vuelve a funcionar (y deja de llenar el historial de avisos repetidos)
30 jul 2026
...
## Versión 18.0.26.88 — El stock vuelve a sincronizarse solo (se arregló una cola que se congelaba)
28 jul 2026
...
## Versión 18.0.26.87 — El costo de envío ya no se pierde de la orden [Elvimarta #508]
27 jul 2026
...
## Versión 18.0.26.84 — "Traer medidas" completa TODAS las variantes, no solo la primera [#424 Deco/KPI]
21 jul 2026
...
## Versión 18.0.26.82 — Comprador (nickname/ID) y zona del receiver buscables en el pedido de venta [#404 Deco/KPI]
19 jul 2026
...
## Versión 18.0.26.83 — Savepoints anti-`InFailedSqlTransaction` al importar categorías y productos [#410 SOLSUN]
20 jul 2026
...
## Versión 18.0.26.80 — Dimensiones e impuestos del producto: import + publish [#424/#474 Deco/KPI]
## Versión 18.0.26.82 — El diagnóstico de stock reactiva de forma EXPLÍCITA las publicaciones pausadas con stock
17 jul 2026
...
## Versión 18.0.26.72 — "Sugerir Categoría" mucho más rápido [#532]
10 jul 2026
...
## Versión 18.0.26.71 — Errores al publicar: ahora legibles, en español y accionables [#532]
10 jul 2026
...
## Versión 18.0.26.70 — Cancelaciones de días anteriores: el barrido ahora cubre TODA la ventana [#475]
10 jul 2026
...
## Versión 18.0.26.66 — Surtido multi-almacén: se captura el depósito de origen de MercadoLibre
8 jul 2026
...
## Versión 18.0.26.65 — Re-sync de cancelaciones ahora soporta multi-cuenta [#475]
8 jul 2026
