...
## Versión 17.0.26.134 — Los reclamos de MercadoLibre vuelven a verse en Odoo, y el link de mensajes lleva al país de la cuenta
23 sep 2026
...
---
## Versión 17.0.26.127 — Las publicaciones sin video vuelven a subir a MercadoLibre [#492 / #577]
21 sep 2026
...
Requiere actualizar el módulo (`-u meli_oerp`).
## Versión 17.0.26.91 — Queda constancia cuando la importación de pedidos corta por el tope configurado
3 ago 2026
...
## Versión 17.0.26.88 — El stock vuelve a sincronizarse solo (se arregló una cola que se congelaba)
28 jul 2026
...
## Versión 17.0.26.87 — El costo de envío ya no se pierde de la orden [Elvimarta #508]
27 jul 2026
...
## Versión 17.0.26.86 — Se elimina la foto fantasma que se agregaba en cada publicación
23 jul 2026
...
## Versión 17.0.26.83 — Savepoints anti-`InFailedSqlTransaction` al importar categorías y productos [#410 SOLSUN]
20 jul 2026
...
## Versión 17.0.26.82 — El diagnóstico de stock reactiva de forma EXPLÍCITA las publicaciones pausadas con stock
17 jul 2026
...
## Versión 17.0.26.80 — "Traer medidas" ahora avisa qué hizo (antes parecía no hacer nada) [#485 Deco/KPI]
15 jul 2026
...
## Versión 17.0.26.71 — Errores al publicar: ahora legibles, en español y accionables [#532]
10 jul 2026
...
## Versión 17.0.26.70 — Cancelaciones de días anteriores: el barrido ahora cubre TODA la ventana [#475]
10 jul 2026
...
## Versión 17.0.26.69 — "Actualizar Título": empujar solo el título de la publicación a Mercado Libre
10 jul 2026
...
## Versión 17.0.26.68 — La fecha de la orden refleja la fecha real de MercadoLibre + cancelación explícita al re-chequear estado
9 jul 2026
...
> aplica a esta versión; por eso 17.0 salta de 26.66 a 26.68.)
...
## Versión 17.0.26.63 — Medidas del paquete: se corrigen valores viejos equivocados al traer de MercadoLibre [#424]
8 jul 2026
...
## Versión 17.0.26.60 — backfill "Traer medidas": resolución de cuentas overridable (multi-cuenta real) [#424 Deco/KPI]
3 jul 2026
...
## Versión 17.0.26.59 — fix del backfill "Traer medidas": corrige el error al ejecutarlo y soporta multi-cuenta [#424 Deco/KPI]
3 jul 2026
