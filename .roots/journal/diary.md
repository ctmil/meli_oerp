...
**2026-07-21** `[16.0.26.84]` — backport: _meli_import_template_attributes escribe a TODAS las variantes de la publicacion [#424 Deco/KPI]
...
**2026-07-10** `[16.0.26.70]` — orders_resync_status: dominio in-flight + order asc [#475]
...
**2026-07-08** `[16.0.26.65]` — `orders_resync_status` acepta `account=None` (multi-cuenta) [#475]
