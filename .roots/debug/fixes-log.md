...
**Migracion SI.** `migrations/16.0.26.142/post-migrate.py` siembra `meli_cancel_reason_code` sobre el
...
### 23 sep 2026 — Landing de la tanda 26.127 + 26.129 sobre 26.133 [#492/#577, #409, #615] (v16.0.26.134)

**Qué entró.** Tres fixes que estaban listos en ramas `claude/*` sin mergear, más el #615 que ya
estaba en `origin/16.0`:
...
### 19 ago 2026 - fix(stock-diag): una respuesta de ERROR de ML se leia como "sin accion" -> corrida VERDE que no reviso nada (16.0.26.95) [#535 Score 361/499]
...
### 3 ago 2026 — `orders_query_iterate`: el truncamiento de la ventana deja rastro (decisión sobre `offset_next`) — v16.0.26.91 `[#427]`
...
**Fix:** `meli_oerp/models/company.py` (v16.0.26.82), branch paused del diagnóstico:
