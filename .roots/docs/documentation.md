...
## Surtido multi-almacén — depósito de origen por línea de orden (8 jul 2026, v16.0.26.66)
...
> Versión Odoo **16.0**. Mismo modelo/campos/método en 17.0/18.0/19.0; sólo cambian
...
El nombre **lógico/de descarga** lo arma el código (`shipment.py` líneas PDF **1860** / ZPL **1879** /
preview jpg **1873**) a partir del `shipping_id` (campo `mercadolibre.shipment.shipping_id` = "Envio Id"
