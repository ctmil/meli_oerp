                    ...
                    if rmess == "cause":
                        ...
                        if len(ecause):
                            for eca in ecause:
                                ...
                                message_html+= '<div role="alert" class="alert alert-'+ecaalertstatus+'" title="Meli Message, Code: %s"><i class="fa fa-'+ecatype+'" role="img" aria-label="Meli Message"/> %s </div>' % (ecacode,ecacodemess)
