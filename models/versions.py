...
# el GTIN es el campo `barcode` de la variante y el SELLER_SKU es su
# `default_code`. Tomarlos como generadores de variantes abre UNA VARIANTE POR
# CADA CODIGO, que es exactamente el problema que vinieron a resolver las
# variantes.
#
# SELLER_SKU hoy se salva solo porque ML lo manda hidden=true; si ML cambiara
# ese flag rompe igual. Por eso va en la lista, no se deja librado al flag.
