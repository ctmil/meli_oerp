...
class res_company(models.Model):
    ...
    mercadolibre_billing_force_on_main = fields.Boolean(
        ...
        default=False,
        help="ESTRATEGIA B: asigna los datos de facturación al contacto principal del comprador "
             "y corrige su nombre al legal, aunque el nickname de ML no coincida con la razón "
             "social. Evita el contacto fiscal separado. Recomendado para personas físicas (AR/CL).",
    )
